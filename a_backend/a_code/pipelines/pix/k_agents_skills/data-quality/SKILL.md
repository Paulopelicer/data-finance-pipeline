---
name: data-quality
description: Skill agnostica para orientar tarefas de Data Quality em projetos de dados, analytics, BI, ciencia de dados e engenharia de dados.
---
...
Orientar a execucao de tarefas de Data Quality com padrao tecnico reutilizavel, validavel e independente de dominio.
...
Use quando o usuario solicitar criacao, revisao, melhoria, validacao ou explicacao relacionada a validacao de schema, nulos, ranges e outputs.
...
- Use a skill data-quality para revisar uma etapa de validacao de schema, nulos, ranges e outputs.
- Use a skill data-quality para criar artefatos tecnicos reutilizaveis em um projeto de dados.
- Use a skill data-quality para validar criterios de aceite e documentar pendencias.
