...
description: Skill agnostica para orientar tarefas de Data Engineering em projetos de dados, analytics, BI, ciencia de dados e engenharia de dados.
---
...
Orientar a execucao de tarefas de Data Engineering com padrao tecnico reutilizavel, validavel e independente de dominio.
...
Use quando o usuario solicitar criacao, revisao, melhoria, validacao ou explicacao relacionada a arquitetura de pipelines, Bronze, Silver, Gold e governanca.
...
- Use a skill data-engineering para revisar uma etapa de arquitetura de pipelines, Bronze, Silver, Gold e governanca.
- Use a skill data-engineering para criar artefatos tecnicos reutilizaveis em um projeto de dados.
- Use a skill data-engineering para validar criterios de aceite e documentar pendencias.
