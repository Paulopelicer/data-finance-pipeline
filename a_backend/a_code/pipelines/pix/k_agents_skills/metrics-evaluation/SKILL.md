...
description: Skill agnostica para orientar tarefas de Metrics Evaluation em projetos de dados, analytics, BI, ciencia de dados e engenharia de dados.
---
...
Orientar a execucao de tarefas de Metrics Evaluation com padrao tecnico reutilizavel, validavel e independente de dominio.
...
Use quando o usuario solicitar criacao, revisao, melhoria, validacao ou explicacao relacionada a avaliacao de metricas tecnicas e de negocio.
...
- Use a skill metrics-evaluation para revisar uma etapa de avaliacao de metricas tecnicas e de negocio.
- Use a skill metrics-evaluation para criar artefatos tecnicos reutilizaveis em um projeto de dados.
- Use a skill metrics-evaluation para validar criterios de aceite e documentar pendencias.
