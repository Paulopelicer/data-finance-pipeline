---
name: bi-analytics
description: Skill agnostica para orientar tarefas de BI Analytics em projetos de dados, analytics, BI, ciencia de dados e engenharia de dados.
---
...
Orientar a execucao de tarefas de BI Analytics com padrao tecnico reutilizavel, validavel e independente de dominio.
...
Use quando o usuario solicitar criacao, revisao, melhoria, validacao ou explicacao relacionada a KPIs, storytelling executivo, camada Gold e leitura de indicadores.
...
- Use a skill bi-analytics para revisar uma etapa de KPIs, storytelling executivo, camada Gold e leitura de indicadores.
- Use a skill bi-analytics para criar artefatos tecnicos reutilizaveis em um projeto de dados.
- Use a skill bi-analytics para validar criterios de aceite e documentar pendencias.
