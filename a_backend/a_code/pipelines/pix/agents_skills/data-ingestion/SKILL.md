---
name: data-ingestion
description: Skill agnostica para orientar tarefas de Data Ingestion em projetos de dados, analytics, BI, ciencia de dados e engenharia de dados.
---
...
Orientar a execucao de tarefas de Data Ingestion com padrao tecnico reutilizavel, validavel e independente de dominio.
...
Use quando o usuario solicitar criacao, revisao, melhoria, validacao ou explicacao relacionada a ingestao de dados publicos, arquivos e fontes batch.
...
- Use a skill data-ingestion para revisar uma etapa de ingestao de dados publicos, arquivos e fontes batch.
- Use a skill data-ingestion para criar artefatos tecnicos reutilizaveis em um projeto de dados.
- Use a skill data-ingestion para validar criterios de aceite e documentar pendencias.
