...
description: Skill agnostica para orientar tarefas de Feature Selection em projetos de dados, analytics, BI, ciencia de dados e engenharia de dados.
---
...
Orientar a execucao de tarefas de Feature Selection com padrao tecnico reutilizavel, validavel e independente de dominio.
...
Use quando o usuario solicitar criacao, revisao, melhoria, validacao ou explicacao relacionada a selecao e avaliacao de variaveis relevantes.
...
- Use a skill feature-selection para revisar uma etapa de selecao e avaliacao de variaveis relevantes.
- Use a skill feature-selection para criar artefatos tecnicos reutilizaveis em um projeto de dados.
- Use a skill feature-selection para validar criterios de aceite e documentar pendencias.
