...
description: Skill agnostica para orientar tarefas de Classification Modeling em projetos de dados, analytics, BI, ciencia de dados e engenharia de dados.
---
...
Orientar a execucao de tarefas de Classification Modeling com padrao tecnico reutilizavel, validavel e independente de dominio.
...
Use quando o usuario solicitar criacao, revisao, melhoria, validacao ou explicacao relacionada a modelagem de classificacao e matriz de confusao.
...
- Use a skill classification-modeling para revisar uma etapa de modelagem de classificacao e matriz de confusao.
- Use a skill classification-modeling para criar artefatos tecnicos reutilizaveis em um projeto de dados.
- Use a skill classification-modeling para validar criterios de aceite e documentar pendencias.
