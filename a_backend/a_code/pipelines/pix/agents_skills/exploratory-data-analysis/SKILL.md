...
description: Skill agnostica para orientar tarefas de Exploratory Data Analysis em projetos de dados, analytics, BI, ciencia de dados e engenharia de dados.
---
...
Orientar a execucao de tarefas de Exploratory Data Analysis com padrao tecnico reutilizavel, validavel e independente de dominio.
...
Use quando o usuario solicitar criacao, revisao, melhoria, validacao ou explicacao relacionada a analise exploratoria, distribuicoes e achados iniciais.
...
- Use a skill exploratory-data-analysis para revisar uma etapa de analise exploratoria, distribuicoes e achados iniciais.
- Use a skill exploratory-data-analysis para criar artefatos tecnicos reutilizaveis em um projeto de dados.
- Use a skill exploratory-data-analysis para validar criterios de aceite e documentar pendencias.
