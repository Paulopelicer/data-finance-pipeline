---
name: data-treatment
description: Skill agnostica para orientar tarefas de Data Treatment em projetos de dados, analytics, BI, ciencia de dados e engenharia de dados.
---
...
Orientar a execucao de tarefas de Data Treatment com padrao tecnico reutilizavel, validavel e independente de dominio.
...
Use quando o usuario solicitar criacao, revisao, melhoria, validacao ou explicacao relacionada a limpeza, padronizacao e tratamento de dados.
...
- Use a skill data-treatment para revisar uma etapa de limpeza, padronizacao e tratamento de dados.
- Use a skill data-treatment para criar artefatos tecnicos reutilizaveis em um projeto de dados.
- Use a skill data-treatment para validar criterios de aceite e documentar pendencias.
