...
description: Skill agnostica para orientar tarefas de Regression Modeling em projetos de dados, analytics, BI, ciencia de dados e engenharia de dados.
---
...
Orientar a execucao de tarefas de Regression Modeling com padrao tecnico reutilizavel, validavel e independente de dominio.
...
Use quando o usuario solicitar criacao, revisao, melhoria, validacao ou explicacao relacionada a modelagem de regressao e metricas de erro.
...
- Use a skill regression-modeling para revisar uma etapa de modelagem de regressao e metricas de erro.
- Use a skill regression-modeling para criar artefatos tecnicos reutilizaveis em um projeto de dados.
- Use a skill regression-modeling para validar criterios de aceite e documentar pendencias.
