...
description: Skill agnostica para orientar tarefas de PySpark Pipeline em projetos de dados, analytics, BI, ciencia de dados e engenharia de dados.
---
...
Orientar a execucao de tarefas de PySpark Pipeline com padrao tecnico reutilizavel, validavel e independente de dominio.
...
Use quando o usuario solicitar criacao, revisao, melhoria, validacao ou explicacao relacionada a SparkSession, transformacoes PySpark, Parquet e execucao local.
...
- Use a skill pyspark-pipeline para revisar uma etapa de SparkSession, transformacoes PySpark, Parquet e execucao local.
- Use a skill pyspark-pipeline para criar artefatos tecnicos reutilizaveis em um projeto de dados.
- Use a skill pyspark-pipeline para validar criterios de aceite e documentar pendencias.
