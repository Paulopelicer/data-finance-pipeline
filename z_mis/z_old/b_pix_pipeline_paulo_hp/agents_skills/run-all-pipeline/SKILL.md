---
name: run-all-pipeline
description: Skill agnostica para orientar tarefas de Run All Pipeline em projetos de dados, analytics, BI, ciencia de dados e engenharia de dados.
---
...
Orientar a execucao de tarefas de Run All Pipeline com padrao tecnico reutilizavel, validavel e independente de dominio.
...
Use quando o usuario solicitar criacao, revisao, melhoria, validacao ou explicacao relacionada a execucao ponta a ponta, Test Few, Test All e Run All.
...
- Use a skill run-all-pipeline para revisar uma etapa de execucao ponta a ponta, Test Few, Test All e Run All.
- Use a skill run-all-pipeline para criar artefatos tecnicos reutilizaveis em um projeto de dados.
- Use a skill run-all-pipeline para validar criterios de aceite e documentar pendencias.
