...
REPORTS_DIR = PROJECT_DIR / "a_backend" / "a_code" / "pipelines" / "pix" / "reports"
METRICS_FILES = [
...
def csv_list_reports() -> dict[str, Any]:
    """Lista arquivos CSV disponiveis nos reports do modulo Pix."""
    files = []
    ...
    return {"reports_dir": _relative(REPORTS_DIR), "csv_files": files, "count": len(files)}
